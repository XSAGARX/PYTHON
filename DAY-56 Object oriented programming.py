...
The procedure we are following till now is the “Procedural Programming” approach.
 ...
 The basic idea of object-oriented programming (OOP) in Python is to use classes 
 ...
 A class is a blueprint or template for creating objects.
   ...
   Properties are the data or state of an object,
     ...
     For example, you could create a class called "Person" that has properties such as name and age,
       ...
       One of the key features of OOP in Python is encapsulation, which means that the internal state of an object
         is hidden and can only be accessed or modified through the object's methods.
